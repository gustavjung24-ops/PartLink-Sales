...
function AppShell() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[radial-gradient(circle_at_top_left,_#fff8e7,_#f3f4f6_45%,_#e2e8f0)] text-slate-900 dark:bg-[radial-gradient(circle_at_top_left,_#1e293b,_#0f172a_45%,_#020617)] dark:text-slate-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-slate-200/70 bg-white/70 backdrop-blur dark:border-slate-800 dark:bg-slate-950/70", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-6xl items-center justify-between px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "text-lg font-semibold tracking-tight", to: "/dashboard", children: "SPARELINK" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavLink,
          {
            className: ({ isActive }) => isActive ? "font-semibold text-sky-600 dark:text-sky-300" : "text-slate-600 dark:text-slate-300",
            to: "/dashboard",
            children: "Dashboard"
          }
        ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-6xl p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
}
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3 rounded-xl border border-slate-200 bg-white/80 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/70", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold", children: "Sales Console" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 dark:text-slate-300", children: "Nền tảng renderer đã sẵn sàng cho logic nghiệp vụ và đồng bộ offline-first." }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Loading app info..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "overflow-auto rounded-md bg-slate-950 p-3 text-xs text-slate-100", children: JSON.stringify(data, null, 2) })
  ] });
}
...
function SettingsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-3 rounded-xl border border-slate-200 bg-white/80 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/70", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Application Settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 dark:text-slate-300", children: "Window controls are wired through typed IPC bridge." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => window.electronAPI.window.minimize(), size: "sm", type: "button", children: "Minimize" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => window.electronAPI.window.toggleMaximize(), size: "sm", type: "button", variant: "outline", children: "Toggle Maximize" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "overflow-auto rounded-md bg-slate-950 p-3 text-xs text-slate-100", children: JSON.stringify(windowState, null, 2) })
  ] });
}
const router = createHashRouter([
  {
    ...
    children: [
      ...
      {
        path: "settings",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, {})
      }
    ]
  }
]);
...
async function persistQueryClientRestore({
  ...
  try {
    const persistedClient = await persister2.restoreClient();
    if (persistedClient) {
      if (persistedClient.timestamp) {
        const expired = Date.now() - persistedClient.timestamp > maxAge;
        const busted = persistedClient.buster !== buster;
        if (expired || busted) {
          return persister2.removeClient();
        } else {
...
async function persistQueryClientSave({
  ...
  await persister2.persistClient(persistClient);
}
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React$2.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppProviders, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) })
);
