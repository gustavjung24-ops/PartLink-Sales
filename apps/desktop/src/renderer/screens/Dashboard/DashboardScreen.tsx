...
import { loadSearchHistory, persistSearchToHistory } from "../../lib/searchHistory";
...
function loadRecentSearches(): string[] {
  return loadSearchHistory(MAX_RECENT_SEARCHES).map((entry) => entry.query);
}

function persistSearch(term: string): void {
  persistSearchToHistory(term, MAX_RECENT_SEARCHES);
}
